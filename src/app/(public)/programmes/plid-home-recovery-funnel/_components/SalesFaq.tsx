    ...
    <ScrollReveal className="bg-surface-container py-24" id="faq">
      <div className="mx-auto max-w-3xl px-6">
        <div className="mb-16 text-center">
          <h3 className="text-4xl font-extrabold">সচরাচর জিজ্ঞাসিত প্রশ্নাবলী</h3>
        </div>
        <div className="space-y-4">
          <details className="group overflow-hidden rounded-2xl border border-outline-variant/10 bg-surface-container-lowest">
            <summary className="flex cursor-pointer list-none items-center justify-between p-6 text-lg font-bold transition-colors hover:text-primary">
              <span>এটি কি পিএলআইডি রোগীদের জন্য নিরাপদ?</span>
              <span className="material-symbols-outlined transition-transform group-open:rotate-180">
                expand_more
              </span>
            </summary>
            <div className="border-t border-outline-variant/5 p-6 pt-0 text-on-surface/70">
