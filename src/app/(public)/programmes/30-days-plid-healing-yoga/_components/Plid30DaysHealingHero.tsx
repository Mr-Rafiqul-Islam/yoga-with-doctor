...
export function Plid30DaysHealingHero({
  variant = "auto",
}: Plid30DaysHealingHeroProps) {
  return (
    <>
      <ScrollReveal
        className={`relative overflow-hidden pb-20 pt-16 lg:pt-32 ${funnelSectionClass(variant)}`}
      >
        <div className="mx-auto grid max-w-7xl items-center gap-4 md:gap-12 px-6 md:grid-cols-2">
          <div className="z-10">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-primary-container/20 px-4 py-1.5 text-primary mx-auto md:mx-0">
              <span className="material-symbols-outlined text-sm">
                verified_user
              </span>
              <span className="text-sm font-semibold uppercase tracking-wider">
                Scientific Proven Formula
              </span>
            </div>
            <h1 className="mb-6 text-center md:text-left text-3xl md:text-5xl font-extrabold !leading-[1.1] text-on-surface ">
              ৯০% PLID রোগীর সার্জারি লাগেনা। অপারেশন বিহীন PLID মুক্ত জীবনের{" "}
            ...
            <p className="mb-10 max-w-xl text-base lg:text-xl leading-relaxed text-on-surface/80">
              সঠিক সময়োপযোগী কনজারভেটিভ চিকিৎসা, নির্দিষ্ট ব্যায়াম, লাইফস্টাইল
              পরিবর্তন ও ওজন নিয়ন্ত্রণের মাধ্যমে ডিস্কের ওপর চাপ কমিয়ে শরীরকে
              স্বাভাবিকভাবে নিরাময় হতে সাহায্য করার জন্য তৈরি এই Doctor Guided-
              30 Days PLID Healing Yoga Program
            </p>
            <div className="mb-12 hidden gap-4 md:flex md:flex-row">
              <a
