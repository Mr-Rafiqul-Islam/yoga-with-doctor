...
/** Dedicated deadline for yoga-for-BP offer display. */
export const OFFER_ENDS_AT_ISO = "2026-06-15T23:59:59.000Z";
...
export function YfbpCountdown({ className }: { className?: string }) {
