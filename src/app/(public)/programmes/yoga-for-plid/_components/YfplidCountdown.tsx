...
/** Dedicated deadline for PLID offer (independent from migraine page). */
export const OFFER_ENDS_AT_ISO = "2026-06-02T23:59:59.000Z";
...
export function YfplidCountdown({ className }: { className?: string }) {
