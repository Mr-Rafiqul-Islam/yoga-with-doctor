...
import { YfplidCountdown } from "./YfplidCountdown";

export function YfplidOfferBar() {
  return (
    <div
      aria-live="polite"
      ...
      style={{ backgroundColor: "var(--yfplid-primary)" }}
    >
      <p className="text-[13px] font-semibold tracking-tight text-white sm:text-sm">
        Offer ends in <YfplidCountdown /> — enroll before the countdown hits zero!
      </p>
    </div>
  );
}
