...
export function ProfileSummaryCard() {
  ...
  return (
    <div>
      ...
      <div className="mt-5 flex w-full items-center justify-evenly rounded-2xl border-t border-border bg-surface p-6 pt-4 shadow-elevation-sm dark:border-gray-700">
