...
export const featuredArticle: FeaturedArticle = {
  ...
  description: "Discover how starting your day with just 10 minutes of mindfulness can structurally change your brain, reduce cortisol levels, and enhance your focus for the entire day.",
  author: {
     name: "Dr. Sarah West",
     ...
     fullBio: "Dr. Sarah West combines her background in internal medicine with 15 years of yoga practice. She believes in an integrative approach to health where Western diagnostics meet Eastern preventative wisdom.",
     profileLink: "#",
    },
...
export const dummyArticleCards: ArticleCardItem[] = [
  {
    ...
    author: {
      ...
      bioSnippet: "Specializing in therapeutic yoga for chronic pain management.",
      fullBio: "Dr. Emily Stone combines her expertise in physical therapy with 12 years of yoga practice, focusing on evidence-based approaches to pain relief and mobility.",
      profileLink: "#",
    },
    actionLabel: "Read More",
    href: "/articles/advanced-yoga-lower-back-pain",
    tags: ["#Flexibility", "#PainRelief", "#TherapeuticYoga"],
    detailsContent: `
...
`,
  },
  {
    ...
    author: {
      ...
      bioSnippet: "Integrating modern nutrition science with traditional healing practices.",
      fullBio: "Dr. Mark Chen is a registered dietitian with a passion for combining evidence-based nutrition with Ayurvedic principles to support optimal health and recovery.",
      profileLink: "#",
    },
    actionLabel: "Unlock Now",
    href: "/articles/anti-inflammatory-diet-yogis",
    tags: ["#Nutrition", "#Recovery", "#Ayurveda"],
    detailsContent: `
...
`,
  },
  {
    ...
    author: {
      ...
      bioSnippet: "Helping professionals find balance through mindful practices.",
      fullBio: "Sarah Jenkins has spent over a decade teaching mindfulness techniques to corporate teams, helping thousands of professionals reduce stress and improve focus.",
      profileLink: "#",
    },
    actionLabel: "Read More",
    href: "/articles/integrating-mindfulness-corporate-life",
    tags: ["#Mindfulness", "#WorkLifeBalance", "#StressRelief"],
    detailsContent: `
...
`,
  },
  {
    ...
    author: {
      ...
      bioSnippet: "Researching the intersection of sleep science and yogic practices.",
      fullBio: "Dr. Alan Grant is a board-certified sleep medicine physician who has dedicated his career to understanding how ancient practices like Yoga Nidra can complement modern sleep medicine.",
      profileLink: "#",
    },
    actionLabel: "Unlock Now",
    href: "/articles/physiology-of-sleep-yoga-nidra",
    tags: ["#Sleep", "#YogaNidra", "#Recovery"],
    detailsContent: `
...
`,
  },
  {
    ...
    author: {
      ...
      bioSnippet: "Teaching functional movement patterns for everyday strength.",
      fullBio: "Lisa Ray combines her background in kinesiology with 15 years of yoga teaching experience, focusing on building functional strength that translates to daily life.",
      profileLink: "#",
    },
    actionLabel: "Read More",
    href: "/articles/building-core-stability-asana",
    tags: ["#CoreStrength", "#FunctionalMovement", "#Asana"],
    detailsContent: `
...
`,
  },
  {
    ...
    tags: ["#Pranayama", "#AnxietyRelief", "#Breathwork"],
    detailsContent: `
...
const articleDetailsBySlug: Record<string, ArticleDetails> = {
  "the-science-of-morning-meditation": {
    slug: "the-science-of-morning-meditation",
    heroImage: {
      src: `${IMG}/AB6AXuD3rWWjBSOe7Z_1EqIrq2-TMzV5aFpDysK9W4952JWtHES4kZLMNKV9pJAkA1K725BBcWIsKtwF19r2tuP0QaymlfwNp9rB5qocTH3L6bkU92zo35H6dPbryTjzjrOn0d09iWbOB6rHfLTnhJJOQleH-EcVAXzbeVbTRVSiYuuJuMZqs_pyzsb6oUR99Z2ot26ONxqvX4q83cjk54j7KasFsZtrpQLN4aVFaJsX84W3jIOVUhLE5BgUSpKlS9afAAQB9HnPH0a85w`,
      alt: "Morning meditation in nature",
    },
    category: "Mental Health",
    readTime: "5 min read",
    title: "The Science of Morning Meditation: Rewiring Your Brain for Peace",
    ...
    leadParagraph:
      "In a world that wakes up to notifications and immediate demands, the ancient practice of morning meditation offers a scientifically backed antidote. It's not just about \"feeling calm\"—it's about structurally changing your brain to handle stress better.",
    tableOfContents: [
      { id: "introduction", label: "Introduction" },
      { id: "cortisol", label: "The Cortisol Connection" },
      { id: "neuroplasticity", label: "Neuroplasticity & Routine" },
      { id: "practice", label: "10-Minute Practice" },
    ],
    sections: [
      {
        id: "introduction",
        heading: "The Morning Mind",
        paragraphs: [
          "When you first wake up, your brain transitions from delta waves (deep sleep) to theta waves (a dreamy, drift state), and then finally into alpha waves (relaxed alertness). This transition period is incredibly fertile ground for setting the tone of your nervous system.",
          "Rushing immediately into high-beta wave activity—checking emails, worrying about the commute—shocks the system into a sympathetic (fight or flight) response before the day has even begun.",
        ],
        medicalInsight: {
          title: "Medical Insight",
          body: "Theta State Window: The first 20 minutes after waking allows access to the subconscious mind more readily than at any other time. Neurologists refer to this as the \"imprint period,\" where positive suggestion and visualization are most effective at rewiring neural pathways.",
        },
      },
      {
        id: "cortisol",
        ...
        paragraphs: [
          "Cortisol, the stress hormone, naturally peaks about 30-45 minutes after waking. This is known as the Cortisol Awakening Response (CAR). While necessary for alertness, an exaggerated CAR is linked to anxiety and chronic stress.",
          "Morning meditation has been shown to blunt this spike, keeping cortisol within a healthy range. By engaging the parasympathetic nervous system through breath awareness, you signal safety to your body.",
        ],
        figure: {
          imageSrc: `${IMG}/AB6AXuCy8gPPmpwwL1jof9Sz8UldKmChU0jc2Oc6tc2sHLcPLKzNn7E59ZiXXWpyI_QFij_wLDNvFQwsWm9WWtNid6BfVKgoeBN07P3xDr27ZVa56tZAPsdf30S2DKrNZy-clM7209D-JJbY2sNfqOb5KTKHVhWreFP1UwEPRqu8JEfu_IdjInRiq9ih51URs-SKNrebWyc2jA3VT5mlOe0XoRlUipOeUfEhGshKdOQu6sub6gGa-_cXHJPX3P1UbMs842f3X43yr_ZGNA`,
          imageAlt: "Meditating helps reduce activity early in the morning",
          caption:
            "Meditating helps reduce activity early in the morning, improving cognitive outcomes.",
        },
        quote: {
          text: "We are what we repeatedly do. Excellence, then, is not an act, but a habit.",
          cite: "— Aristotle (via Will Durant)",
        },
      },
      {
        id: "neuroplasticity",
        heading: "Neuroplasticity & Routine",
        paragraphs: [
          "The concept of neuroplasticity suggests that our brains are malleable. A study from Harvard Medical School found that 8 weeks of consistent mindfulness practice increased gray matter density in the hippocampus (associated with learning and memory) and decreased gray matter density in the amygdala (associated with anxiety and stress).",
          "The morning is the ideal time for this \"workout\" because willpower is a finite resource that depletes throughout the day. By anchoring the habit to waking up, you bypass the decision fatigue that often derails evening practices.",
        ],
      },
      {
        id: "practice",
        heading: "A Simple 10-Minute Practice",
        paragraphs: [],
      },
    ],
    numberedList: [
      {
        title: "Hydrate",
        description:
          "Drink a glass of water immediately upon waking to activate the metabolism.",
      },
      {
        title: "Seat",
        description:
          "Sit upright. Do not meditate lying in bed, as the brain associates that position with sleep.",
      },
      {
        title: "Breath (4-7-8)",
        description:
          "Inhale for 4 counts, hold for 7, exhale for 8. Repeat for 5 minutes.",
      },
      {
        title: "Intention",
        description:
          "Set one word as your intention for the day (e.g., \"Patience,\" \"Focus,\" \"Kindness\").",
      },
    ],
    tags: ["#Mindfulness", "#Neuroscience", "#MorningRoutine"],
    relatedArticleSlugs: [
      "pranayama-for-anxiety-doctors-perspective",
      "physiology-of-sleep-yoga-nidra",
      "integrating-mindfulness-corporate-life",
    ],
  },
};

/**
 * Get full article details by slug. Returns null if no details exist (e.g. card-only article).
 */
export function getArticleDetailsBySlug(slug: string): ArticleDetails | null {
  return articleDetailsBySlug[slug] ?? null;
}

/**
 * Get article card by slug (from list/grid).
 */
export function getArticleCardBySlug(slug: string): ArticleCardItem | null {
  return dummyArticleCards.find((a) => a.slug === slug) ?? null;
}

/**
 * Get related article cards for a details page (by slugs).
 */
export function getRelatedArticles(slugs: string[]): ArticleCardItem[] {
  return slugs
    .map((s) => getArticleCardBySlug(s))
    .filter((a): a is ArticleCardItem => a != null);
}
